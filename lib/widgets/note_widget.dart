  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return main.session.note.data.length == 0
            ? Offstage()
            : Column(
                children: main.session.note.data
                  ...
                  return Padding(
                    padding: EdgeInsets.symmetric(
                      horizontal: (40 / 207) *
                          constraints
                              .maxWidth, // 207 è il maxWIdth dell'iphone 11 Pro Max
                    ),
                    child: SizedBox(
                      height: 100 + 20.0,
                      child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      margin: EdgeInsets.symmetric(
                                        horizontal:
                                            (27 / 207) * constraints.maxWidth,
                                      ),
                                      padding: EdgeInsets.symmetric(
                                        vertical:
                                            (9 / 207) * constraints.maxWidth,
                                      ),
                                      alignment: Alignment.center,
                                      decoration: BoxDecoration(
                                        color:
                                            Globals.coloriNote[nota.tipologia],
                                    ...
                                    Padding(
                                      padding: EdgeInsets.symmetric(
                                          vertical:
                                              (5 / 207) * constraints.maxWidth),
                                      child: AutoSizeText(
                                        nota?.date != null
                                            ? Nota.getDateWithSlashes(
                                                nota?.date)
